...
public class NeuralNetwork {
	 ...
	 */
	public NeuralNetwork(int BoardSize) throws IOException
	{
		this.boardSize = BoardSize;
		setNetwork(this.boardSize);		
	}
	 ...
	 * @throws IOException Exception if there is a trouble in reading the weight files.
	 */
	public void setNetwork(int BoardSize) throws IOException
	{		
		loadNetwork("AIweights/" + String.valueOf(BoardSize));
	}
	...
	{
		return argMax(output(boardToArray(board)));
	}
	
	
	/**
	 * Makes Float[] list from board for the neural network computations
	 * 
	 * @param board Input board
	 * @return Output list
	 */
	private Float[] boardToArray(Board board) {
		List<Float> temps = new ArrayList<Float>();		
		for (BoardCell cell : board.cells)
		{
